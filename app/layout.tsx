...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: "浏览 8 个主流品牌的现行成人网球拍，按拍系、类型与代际查参数；用六维雷达图匹配对比，并查看 ATP/WTA 球星公开用拍。",
    applicationName: "拍库 RACKET ARSENAL",
    openGraph: {
      title: "拍库｜RACKET ARSENAL",
      description: "现行拍系年鉴、六维雷达对比与 ATP/WTA 球星公开用拍，一站找到更合拍的下一把武器。",
      type: "website",
      locale: "zh_CN",
    ...
    twitter: {
      ...
      title: "拍库｜RACKET ARSENAL",
      description: "现行拍系年鉴、六维雷达对比与 ATP/WTA 球星公开用拍。",
